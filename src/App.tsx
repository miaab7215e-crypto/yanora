          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                  ...
                  <div className="space-y-3 w-full">
                    <div className="flex items-center gap-3 justify-center">
                      <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center overflow-hidden">
                        <img src="/c324214cb2a62d16d00510d9652c0f60.jpg" alt="Doctor 1" className="w-full h-full object-cover" />
                      </div>
                      <div className="text-left">
                        <div className="font-medium" style={{color: '#1F1F1F'}}>Dr Shim Ching</div>
                        <div className="text-sm" style={{color: '#6B7280'}}>Certified Plastic Surgeon</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 justify-center">
                      <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center overflow-hidden">
                        <img src="/68744e766a6b63d88f86d714366bcd31.jpg" alt="Doctor 2" className="w-full h-full object-cover" />
                      </div>
                      <div className="text-left">
                        <div className="font-medium" style={{color: '#1F1F1F'}}>Dr Gary Linkov</div>
                        <div className="text-sm" style={{color: '#6B7280'}}>Hair & Lip Aesthetic Specialist</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 justify-center">
                      <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center overflow-hidden">
                        <img src="/3d931fc8d4b7d9ba6357f51f842da33d.jpg" alt="Doctor 3" className="w-full h-full object-cover" />
                      </div>
                      <div className="text-left">
                        <div className="font-medium" style={{color: '#1F1F1F'}}>Jonathan Zelken, MD</div>
                        <div className="text-sm" style={{color: '#6B7280'}}>Facial Rejuvenation Expert</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="text-center mt-6">
                  <div className="text-xl md:text-2xl font-light mb-2" style={{color: '#1F1F1F'}}>Recommended by Leading Doctors</div>
                  <div className="text-sm" style={{color: '#6B7280'}}>Supported by world-renowned experts.</div>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection animation="fade-up" delay={300}>
              ...
              >
                <div className="flex-1 flex items-center justify-center">
                  <div className="grid grid-cols-3 gap-2 w-full max-w-xs">
                    ...
                    <div className="aspect-square bg-white rounded-lg flex items-center justify-center">
                      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" stroke="#D1D5DB" strokeWidth="2">
                        <ellipse cx="20" cy="16" rx="8" ry="6"/>
                      </svg>
                    </div>
                    <div className="aspect-square bg-white rounded-lg"></div>
                    <div className="aspect-square bg-white rounded-lg flex items-center justify-center">
                      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" stroke="#D1D5DB" strokeWidth="2">
                        <path d="M10 20 Q 15 10, 20 20 Q 25 30, 30 20"/>
                      </svg>
                    </div>
                    <div className="aspect-square bg-white rounded-lg p-2 text-center flex items-center justify-center">
                      <div className="text-xs leading-tight" style={{color: '#6B7280'}}>Non-Surgical</div>
                    </div>
                    <div className="aspect-square bg-white rounded-lg flex items-center justify-center">
                      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" stroke="#D1D5DB" strokeWidth="2">
                ...
                <div className="text-center mt-6">
                  <div className="text-xl md:text-2xl font-light mb-2" style={{color: '#1F1F1F'}}>Surgery-Free</div>
                  <div className="text-sm" style={{color: '#6B7280'}}>Effective enhancements, no surgery required.</div>
                </div>
              </div>
            </AnimatedSection>
          </div>
